...
const de = {
    ...
    ui: {
        ...
        coach: {
            movement: 'Bewegung: klicke ein erreichbares Hex ({points} MP) · Zahl = Kosten',
            movementCombat: 'Bewegung ({points} MP) — rote Hexes: Kampf gegen {enemy}',
            combatStarts: 'Kampf gegen {enemy}!',
            enemyFallback: 'Feind',
            ranged: 'Fernkampf: Fern-/Belagerungskarten oder Phase überspringen',
            rangedFortified: 'Fernkampf: 🏰 Befestigt braucht Belagerung — sonst Phase überspringen',
            block: 'Block: spiele Block-Karten (hervorgehoben), dann Block beenden',
            blockProgress: 'Block {have}/{need}{swift}{outcome}',
            blockSafe: ' · sicher',
            blockWounds: ' · sonst {wounds} Wunden',
            swiftNote: ' · 💨 2× Block',
            damage: 'Schaden wird verrechnet…',
            attack: 'Angriff: spiele Angriffskarten (hervorgehoben), dann ausführen',
            attackProgress: 'Angriff {attack} — spiele Angriffskarten, dann ausführen',
            attackCanDefeat: 'Angriff {attack} — besiegbar: {names}',
            combatEnd: 'Kampf vorbei — beenden',
            combat: 'Kampf läuft',
            heal: 'Heilung bereit — nutze „Heilen“',
            site: 'Ort hier — besuchen/erkunden',
            hasMp: '{points} MP — klicke ein erreichbares Hex · Zahl = Kosten',
        ...
        cardReasons: {
            ...
            wrongPhaseBlock: 'Jetzt Block-Phase — diese Karte blockt nicht',
            wrongPhaseAttack: 'Jetzt Angriff-Phase — diese Karte greift nicht an',
            wrongPhaseRanged: 'Jetzt Fernkampf — keine Fern-/Belagerungskarte',
            recommendedBlock: 'Empfohlen: Block',
            recommendedAttack: 'Empfohlen: Angriff',
            recommendedMove: 'Empfohlen: Bewegung',
            recommendedRanged: 'Empfohlen: Fernkampf',
        },
        hints: {
            end: '🏁 Kampf endet',
            ...
            rangedHint: 'Hervorgehobene Karten = Fernkampf · Space = überspringen',
            blockHint: 'Hervorgehobene Karten = Block · dann „Block beenden“',
            attackHint: 'Hervorgehobene Karten = Angriff · Space = ausführen',
    ...
    combat: {
        ...
        autoSkipRanged: 'Keine Fernkampf-Karten — Phase übersprungen',
        ui: {
            totalBlock: 'Block',
            totalAttack: 'Angriff',
            ranged: 'Fernkampf',
            siege: 'Belagerung',
            prediction: 'Vorschau',
            woundsExpected: 'Wunden erwartet',
            poison: '+ GIFT!',
            noDamage: 'Kein Schaden erwartet',
            defeatable: 'Besiegbar',
            notEnoughAttack: 'Noch nicht genug Angriff für einen Kill',
            assassin: 'Attentäter!',
            assassinHint: 'Schaden muss der Held nehmen.',
            needsBlock: 'Benötigt',
            blocked: 'GEBLOCKT',
            attack: 'Angriff'
        },
        traits: {
            fortifiedShort: 'nur Belagerung',
            swiftShort: '2× Block',
            poisonShort: 'Gift-Wunden',
            vampiricShort: '+Rüstung',
            brutalShort: '2× Schaden',
            paralyzeShort: 'Lähmung',
            cumbersomeShort: 'MP senkt Block',
            assassinShort: 'nur Held',
            summonerShort: 'ruft herbei',
            elusiveShort: 'hohe Rüstung',
            bossShort: 'Boss'
        }
    },
